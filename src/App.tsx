...
const reelsMessages: { id: string; author: string; message: string; time: string }[] = []
...
const FLAPPY_QUESTIONS: ExamQuestion[] = [
  { topic: 'Coima', icon: '💰', question: '¿Qué es una coima?', options: ['Una multa de tránsito', 'Dinero o favores para lograr algo indebido', 'Un juego', 'Un regalo entre amigos'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '¿Cuál es un ejemplo de coima?', options: ['Ayudar a un amigo', 'Un policía pide dinero para no multar', 'Devolver una billetera', 'Pagar el precio justo'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '¿Quiénes participan en una coima?', options: ['Nadie en realidad', 'Un saludo', 'Solo un fantasma', 'Quien ofrece y quien acepta'], correct: 3 },
  { topic: 'Coima', icon: '💰', question: 'Un inspector dice “págame y cierro los ojos”. ¿Qué es?', options: ['Una coima', 'Una propina', 'Un trámite normal', 'Solo los testigos'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: '¿Una coima puede ser un favor y no dinero?', options: ['Solo los lunes', 'Sí, también favores o regalos', 'Solo en sueños', 'No, solo es dinero'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: 'Si te ofrecen una coima, ¿qué debes hacer?', options: ['Aceptarla rápido', 'Esconderlo', 'Pedir más dinero', 'Rechazarla y contarle a un adulto'], correct: 3 },
  { topic: 'Coima', icon: '💰', question: '¿Por qué la gente ofrece coimas?', options: ['Por amor al arte', 'Para saltarse reglas y ganar rápido', 'Por generosidad', 'Para ayudar a todos'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '“Todos pagan para pasar”. ¿Qué respondes?', options: ['Me voy sin decir nada', 'Seguir pagando', 'Pago también', 'No pago y respeto la fila'], correct: 3 },
  { topic: 'Coima', icon: '💰', question: '¿Qué siente quien pierde su turno por una coima?', options: ['Tristeza e injusticia', 'Nada en especial', 'Alegría', 'Ganas de pagar'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: '¿Aceptar una coima también es corrupción?', options: ['Solo a veces', 'Solo mirar', 'Solo el que ofrece', 'Sí, quien acepta también rompe reglas'], correct: 3 },
  { topic: 'Soborno', icon: '🤝', question: 'Un vendedor regala algo caro al inspector para que no revise. Es…', options: ['Un soborno', 'Un descuento', 'Cortesía', 'Amabilidad'], correct: 0 },
  { topic: 'Soborno', icon: '🤝', question: '¿Qué busca quien soborna?', options: ['Paz mundial', 'Hacer amigos', 'Ayudar a todos', 'Una ventaja indebida'], correct: 3 },
  { topic: 'Soborno', icon: '🤝', question: '¿El soborno afecta a otras personas?', options: ['A los árboles', 'Sí, quita oportunidades a otros', 'No, solo a quien paga', 'Solo al inspector'], correct: 1 },
  { topic: 'Soborno', icon: '🤝', question: 'Te ofrecen un premio por callar una trampa. ¿Qué haces?', options: ['Lo rechazo y lo cuento', 'Pedir tres premios', 'Pido dos premios', 'Lo acepto'], correct: 0 },
  { topic: 'Soborno', icon: '🤝', question: '¿Cuál es la diferencia entre propina y soborno?', options: ['La propina agradece; el soborno compra favores', 'No hay diferencia', 'Son iguales', 'La propina es más cara'], correct: 0 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Cuál es una señal de alerta?', options: ['Un abrazo', 'Te dan comprobante', 'Te explican con calma', 'Te piden decidir rápido y en secreto'], correct: 3 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Te piden dinero “sin recibo”. ¿Qué sospechas?', options: ['Es un sorteo', 'Un premio', 'Es una coima', 'Es un descuento'], correct: 2 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Qué frase es típica de una coima?', options: ['“Todo queda registrado”', '“Buenos días”', '“Arreglemos entre nosotros”', '“Pasa mañana con cita”'], correct: 2 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Un trámite sin fila a cambio de dinero es…', options: ['Magia', 'Suerte', 'Corrupción', 'Eficiencia'], correct: 2 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Qué debes pedir siempre en un trámite?', options: ['Un atajo', 'Un favor', 'Comprobante o recibo', 'Un autógrafo'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: '¿A quién dañan las coimas?', options: ['A toda la sociedad', 'A nadie', 'A los marcianos', 'Solo a quien paga'], correct: 0 },
  { topic: 'El daño', icon: '💔', question: 'El dinero de coimas en obras podría usarse en…', options: ['Fiestas privadas', 'En cohetes de juguete', 'Nada importante', 'Escuelas y hospitales'], correct: 3 },
  { topic: 'El daño', icon: '💔', question: '¿Qué pierde un niño cuando otro compra su lugar?', options: ['Un juguete', 'Un caramelo', 'Su oportunidad ganada con esfuerzo', 'Nada'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: 'Las coimas en hospitales provocan…', options: ['Más médicos', 'Más doctores', 'Menos medicinas para todos', 'Mejor atención'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: '¿Por qué una coima pequeña también daña?', options: ['Porque es barata', 'No daña', 'Porque rompe reglas y quita recursos', 'Porque es pequeña'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: '¿Qué es “mordida” en otros países?', options: ['Un impuesto', 'Una fruta', 'Un dulce', 'Otro nombre para la coima'], correct: 3 },
  { topic: 'Coima', icon: '💰', question: 'Un chofer paga para evitar una multa justa. ¿Qué es?', options: ['Un peaje', 'Ahorro', 'Viveza', 'Coima'], correct: 3 },
  { topic: 'Coima', icon: '💰', question: '¿La coima existe solo en el gobierno?', options: ['No, en escuelas y barrios también', 'Solo en la luna', 'Sí, solo ahí', 'Solo en otros países'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: 'Pagar para entrar a un equipo sin prueba es…', options: ['Entrenamiento', 'Suerte', 'Mérito', 'Trampa corrupta'], correct: 3 },
  { topic: 'Coima', icon: '💰', question: '¿Qué protege decir que no a una coima?', options: ['El trato justo para todos', 'Nada', 'Al que ofreció', 'Al inspector corrupto'], correct: 0 },
  { topic: 'Soborno', icon: '🤝', question: '¿Sobornar para ganar un concurso es justo?', options: ['Solo si nadie ve', 'Sí, si ganas', 'Un atajo válido', 'No, roba el premio al mejor'], correct: 3 },
  { topic: 'Soborno', icon: '🤝', question: 'Un juez recibe regalos de una parte. ¿Qué pasa?', options: ['Nada malo', 'Amistad verdadera', 'Justicia vendida e injusta', 'Mejor juicio'], correct: 2 },
  { topic: 'Soborno', icon: '🤝', question: '¿Cómo se llama pagar para obtener algo indebido?', options: ['Soborno', 'Impuesto', 'Sueldo', 'Un préstamo'], correct: 0 },
  { topic: 'Soborno', icon: '🤝', question: 'Si ves un soborno, ¿qué haces?', options: ['Lo cuentas a un adulto de confianza', 'Unirte a ellos', 'Te unes', 'Lo grabas y lo vendes'], correct: 0 },
  { topic: 'Soborno', icon: '🤝', question: '¿El que recibe el soborno es inocente?', options: ['Solo si es mucho', 'No, también es responsable', 'Sí, totalmente', 'Siempre'], correct: 1 },
  { topic: 'Reconocerla', icon: '🔍', question: '“Sin testigos, mejor”. ¿Qué indica?', options: ['Profesionalismo', 'Rapidez', 'Eficiencia', 'Que algo indebido se esconde'], correct: 3 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Dónde NO hay corrupción?', options: ['Donde todo es claro y con reglas', 'Donde se paga en secreto', 'Donde nadie pregunta', 'Donde nadie mira'], correct: 0 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Un precio distinto según la cara del cliente es…', options: ['Marketing', 'Abuso e injusticia', 'Suerte', 'Oferta especial'], correct: 1 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Qué te protege de las coimas?', options: ['Llevar mucho dinero', 'Conocer tus derechos y hablar', 'Tener suerte', 'No salir de casa'], correct: 1 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Piden “colaboración” para darte tu certificado. ¿Qué es?', options: ['Un saludo', 'Una coima disfrazada', 'Un impuesto', 'Una donación'], correct: 1 },
  { topic: 'El daño', icon: '💔', question: 'Sin coimas, las filas serían…', options: ['Más aburridas', 'Iguales', 'Más lentas', 'Más justas para todos'], correct: 3 },
  { topic: 'El daño', icon: '💔', question: '¿Qué se rompe con cada coima?', options: ['El dinero', 'Nada', 'La confianza entre personas', 'Un vidrio'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: 'Un hospital sin medicinas por desvíos muestra…', options: ['Un milagro', 'El daño real de la corrupción', 'Falta de médicos', 'Mala suerte'], correct: 1 },
  { topic: 'El daño', icon: '💔', question: '¿Quiénes sufren más la corrupción?', options: ['Los aviones', 'Los más ricos', 'Los más vulnerables', 'Nadie'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: 'Cada coima aceptada enseña que…', options: ['Ser honesto paga', 'La trampa funciona', 'A volar', 'Nada'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '¿Rechazar una coima es…?', options: ['Un problema', 'Mala educación', 'De mala suerte', 'Valiente honestidad'], correct: 3 },
  { topic: 'Coima', icon: '💰', question: 'Decir “no, gracias” ante dinero indebido demuestra…', options: ['Que eres rico', 'Debilidad', 'Integridad', 'Miedo'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: '¿Qué gana quien rechaza coimas?', options: ['Nada', 'Enemigos', 'Tranquilidad y respeto', 'Un trofeo'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: 'Contar sobre una coima a un adulto es…', options: ['Ser entrometido', 'Chismear', 'Denunciar con valentía', 'Meterse en líos'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: '¿La honestidad frente a coimas te protege?', options: ['Solo un rato', 'Sí, toda la vida', 'Solo a famosos', 'No sirve'], correct: 1 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Un funcionario le da un trabajo público a su familiar sin concurso. ¿Qué ocurrió?', options: ['Un abrazo', 'Nada malo', 'Un sorteo', 'Nepotismo, una forma de corrupción'], correct: 3 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿Qué es el nepotismo?', options: ['Dar puestos a familiares sin concurso', 'Un postre', 'Un sorteo', 'Un deporte'], correct: 0 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿Por qué el nepotismo es injusto?', options: ['No lo es', 'Porque sí', 'Quita oportunidades a los más capaces', 'Es tradición'], correct: 2 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Si tu familiar es el mejor y gana el concurso, ¿es nepotismo?', options: ['No, ganó con mérito', 'Depende del día', 'Un problema', 'Sí, siempre'], correct: 0 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿Quién debe pagar impuestos?', options: ['Los extraterrestres', 'Solo los ricos', 'Nadie', 'Todos los que la ley indica'], correct: 3 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿Para qué sirven los impuestos?', options: ['Para fiestas privadas', 'Para comprar juguetes', 'Para nada', 'Para escuelas, hospitales y caminos'], correct: 3 },
  { topic: 'Impuestos', icon: '🏛️', question: 'No pagar impuestos que te tocan es…', options: ['Una falta contra todos', 'Viveza', 'Ahorro', 'Un deporte'], correct: 0 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿Qué pasa si nadie paga impuestos?', options: ['No habría escuelas ni hospitales', 'Nada', 'Todo gratis', 'Todo mejora'], correct: 0 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Pedir comprobante al pagar ayuda a…', options: ['Que los impuestos lleguen a su destino', 'A decorar', 'Perder tiempo', 'Nada'], correct: 0 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Los impuestos son…', options: ['Un juego', 'El aporte de todos para todos', 'Un regalo', 'Un castigo'], correct: 1 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Qué es la transparencia?', options: ['Mostrar cómo se gasta el dinero público', 'Hablar mucho', 'Un color', 'Esconder información'], correct: 0 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Por qué importa la transparencia?', options: ['Para aburrir', 'Evita trampas a escondidas', 'No importa', 'Es aburrida'], correct: 1 },
  { topic: 'Transparencia', icon: '🔍', question: 'Un alcalde publica todos los gastos en internet. Eso es…', options: ['Pérdida de tiempo', 'Un chisme', 'Transparencia', 'Presumir'], correct: 2 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Qué frase pide transparencia?', options: ['“Confía y no preguntes”', '“Muéstrame las cuentas, por favor”', '“Tú págame”', '“Mejor no saber”'], correct: 1 },
  { topic: 'Transparencia', icon: '🔍', question: 'Sin transparencia, es más fácil…', options: ['Ser felices', 'Ser justo', 'Esconder corrupción', 'Ahorrar'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: '¿Qué es rendir cuentas?', options: ['Esconderse', 'Contar chistes', 'Explicar en qué se usó lo confiado', 'Dormir siesta'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: '¿Quién debe rendir cuentas?', options: ['Quien administra algo de otros', 'Solo los niños', 'Nadie', 'Los gatos'], correct: 0 },
  { topic: 'Rendición', icon: '🧾', question: 'Un tesorero muestra todos los recibos del grupo. ¿Qué hace?', options: ['Hace magia', 'Presume', 'Rinde cuentas', 'Pierde tiempo'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: 'Rendir cuentas genera…', options: ['Confianza', 'Enemigos', 'Desconfianza', 'Pleitos'], correct: 0 },
  { topic: 'Rendición', icon: '🧾', question: 'Si administras dinero del salón, debes…', options: ['Anotar y mostrar cada gasto', 'Gastarlo en secreto', 'Regalarlo', 'Comprar dulces'], correct: 0 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿El nepotismo daña a otros?', options: ['Sí, roba oportunidades', 'Solo un poco', 'A las plantas', 'No'], correct: 0 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Elegir a un amigo para un cargo sin evaluar a nadie es…', options: ['Amistad', 'Ser popular', 'Nepotismo', 'Suerte'], correct: 2 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿Cómo se evita el nepotismo?', options: ['Con secretos', 'Cerrar los ojos', 'Con más amigos', 'Con concursos justos y abiertos'], correct: 3 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Un concurso abierto con jurado es…', options: ['Justo y transparente', 'Lento e inútil', 'Una fiesta', 'Injusto'], correct: 0 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'El mérito significa…', options: ['Ser famoso', 'Que te elijan por capacidad y esfuerzo', 'Tener contactos', 'Tener suerte'], correct: 1 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿De quién es el dinero de los impuestos?', options: ['De nadie', 'Del banco', 'De todos los ciudadanos', 'Del alcalde'], correct: 2 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Evadir impuestos es…', options: ['Normal', 'Un juego', 'Quitarle recursos a todos', 'Inteligente'], correct: 2 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿Qué financian los impuestos?', options: ['Viajes de funcionarios', 'Fiestas', 'Dulces para todos', 'Escuelas, salud y caminos'], correct: 3 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Pagar impuestos es…', options: ['Un castigo', 'Opcional', 'Un deber ciudadano', 'Divertido'], correct: 2 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Si una obra cuesta el triple por sobreprecios, eso es…', options: ['Corrupción', 'Inflación', 'Un milagro', 'Calidad'], correct: 0 },
  { topic: 'Transparencia', icon: '🔍', question: 'El acceso a la información pública es…', options: ['Un favor', 'Un derecho', 'Un secreto', 'Un privilegio'], correct: 1 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Qué herramienta frena la corrupción?', options: ['El secreto', 'La paciencia sola', 'La transparencia y la denuncia', 'Una varita mágica'], correct: 2 },
  { topic: 'Transparencia', icon: '🔍', question: 'Ocultar gastos públicos genera…', options: ['Confianza', 'Alegría', 'Ahorro', 'Desconfianza'], correct: 3 },
  { topic: 'Transparencia', icon: '🔍', question: 'Publicar las decisiones ayuda a…', options: ['Aburrir', 'A confundir más', 'Vigilar que todo sea justo', 'Confundir'], correct: 2 },
  { topic: 'Transparencia', icon: '🔍', question: 'La luz es enemiga de…', options: ['De la noche', 'El día', 'Las plantas', 'La corrupción'], correct: 3 },
  { topic: 'Rendición', icon: '🧾', question: '¿Qué muestra quien rinde cuentas?', options: ['Miedo', 'Nada', 'Honestidad', 'Culpa'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: 'No rendir cuentas permite…', options: ['La confianza', 'El orden', 'Esconder desvíos', 'Ahorra tiempo'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: 'Tu grupo te eligió tesorero. ¿Qué haces?', options: ['Muestro cada gasto al grupo', 'Esconder la alcancía', 'Lo presto a amigos', 'Guardo el dinero en secreto'], correct: 0 },
  { topic: 'Rendición', icon: '🧾', question: '¿Cada cuánto se debe rendir cuentas?', options: ['Cuando hay fiesta', 'Siempre que se maneje algo ajeno', 'Nunca', 'Una vez y ya'], correct: 1 },
  { topic: 'Rendición', icon: '🧾', question: 'Rendir cuentas protege…', options: ['A nadie', 'Los recursos de todos', 'Al olvido', 'Al tesorero corrupto'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'Un dirigente se queda con dinero de la escuela. ¿Qué es?', options: ['Un error', 'Ahorro', 'Préstamo', 'Corrupción'], correct: 3 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué debe hacer quien administra dinero del grupo?', options: ['Repartirlo entre amigos', 'Rendir cuentas y usarlo para el fin acordado', 'Esconderlo', 'Gastarlo'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'Las leyes son iguales para…', options: ['Los semáforos', 'Los ricos', 'Todas las personas por igual', 'Los políticos'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué promueve rechazar coimas?', options: ['La viveza', 'El miedo', 'La flojera', 'La integridad'], correct: 3 },
  { topic: 'Mixto', icon: '🌱', question: 'Un pueblo que vigila a sus autoridades…', options: ['Pierde tiempo', 'Cansancio', 'Frena la corrupción', 'Se mete en líos'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Denunciar por canales seguros es…', options: ['Chisme', 'Valentía ciudadana', 'Peligroso siempre', 'Quedarse dormido'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué necesita un país contra la corrupción?', options: ['Más dinero', 'Más feriados', 'Ciudadanos honestos e instituciones fuertes', 'Más secretos'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'El silencio ante la corrupción…', options: ['No afecta', 'Música', 'La deja crecer', 'Ayuda'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Hablar y denunciar es…', options: ['Un susurro', 'Inútil', 'El primer paso para detenerla', 'Peligroso'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: '¿Cuál es el mensaje de este juego?', options: ['Gana como sea', 'La integridad siempre gana', 'Volar alto', 'Paga para ganar'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: '¿Es honesto decir la verdad aunque cueste?', options: ['Ser callado', 'Depende', 'Nunca', 'Sí, la honestidad es un valor'], correct: 3 },
  { topic: 'Honestidad', icon: '💎', question: 'Encuentras dinero perdido. ¿Qué muestra integridad?', options: ['Gastarlo', 'Devolverlo con todo su contenido', 'Comprar dulces', 'Quedarte la mitad'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: '¿Qué es hacer trampa en un examen?', options: ['Copiar o hacer trampa', 'Estudiar mucho', 'Un recreo', 'Preguntar al profesor'], correct: 0 },
  { topic: 'Honestidad', icon: '💎', question: 'Copiar la tarea y firmarla es…', options: ['Plagio deshonesto', 'Ayuda', 'Un dibujo', 'Trabajo en equipo'], correct: 0 },
  { topic: 'Honestidad', icon: '💎', question: 'La honestidad se demuestra cuando…', options: ['Cuando todos miran', 'Cuando hay dulces', 'Cuando hay premio', 'Cuando nadie mira'], correct: 3 },
  { topic: 'Honestidad', icon: '💎', question: '¿Por qué cuesta ser honesto a veces?', options: ['Porque llueve', 'Porque no conviene', 'Porque exige valentía', 'Porque es aburrido'], correct: 2 },
  { topic: 'Honestidad', icon: '💎', question: 'Un amigo te pide copiar. ¿Qué propones?', options: ['Copiar también', 'Nada', 'Copiar', 'Estudiar juntos'], correct: 3 },
  { topic: 'Honestidad', icon: '💎', question: 'Decir la verdad aunque traiga problemas es…', options: ['Inútil', 'De valientes', 'Tonto', 'Ser gruñón'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: '¿La honestidad se entrena?', options: ['Comiendo', 'Sí, con actos pequeños diarios', 'Solo de mayor', 'No se puede'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: '¿Qué gana una persona honesta?', options: ['Enemigos', 'Un helado', 'Nada', 'Confianza y respeto'], correct: 3 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Qué le puede pasar a quien ofrece coimas?', options: ['Nada malo', 'Nada', 'Prisión, multas e inhabilitación', 'Un premio'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Además de lo legal, la corrupción destruye…', options: ['Los semáforos', 'Las nubes', 'Los feriados', 'La confianza entre ciudadanos'], correct: 3 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿La corrupción tiene castigo?', options: ['Solo retos', 'No', 'Sí, la ley la sanciona', 'Solo multas de juguete'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Quien roba dinero público deberá…', options: ['Quedárselo', 'Esconderlo mejor', 'Ser famoso', 'Devolverlo y responder ante la ley'], correct: 3 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Por qué existen castigos contra la corrupción?', options: ['Por tradición', 'Para asustar', 'Para proteger a todos y desanimar trampas', 'Por venganza'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Una mala fama por corrupto dura…', options: ['Nada', 'Mucho tiempo', 'Un día', 'Un recreo'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Qué pierde un corrupto descubierto?', options: ['Sus llaves', 'Confianza y reputación', 'Nada', 'Dinero y premios'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Las consecuencias llegan…', options: ['Tarde o temprano', 'En bicicleta', 'Nunca', 'Solo a otros'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿A quién castiga la ley anticorrupción?', options: ['A los pájaros', 'A quien ofrece y a quien acepta', 'A los testigos', 'A los honestos'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Evitar la corrupción te evita…', options: ['La tarea', 'Dinero', 'Problemas legales y culpa', 'Amigos'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Cómo se previene la corrupción?', options: ['Pagando más rápido', 'Exigiendo transparencia y denunciando', 'Con magia', 'Ignorando todo'], correct: 3 },
  { topic: 'Prevención', icon: '🛡️', question: 'Si ves algo incorrecto en tu municipio, puedes…', options: ['Callar', 'Pedir un deseo', 'Denunciar por canales seguros', 'Participar'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: 'Prevenir es mejor porque…', options: ['Es más caro', 'Evita el daño antes de que ocurra', 'Es aburrido', 'Porque sí'], correct: 1 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Qué frena las coimas en un trámite?', options: ['Trámites claros y comprobantes', 'Con prisa', 'Pagar más', 'Ir de noche'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: 'En tu escuela, ¿cómo previenes trampas?', options: ['Reglas claras y honestidad', 'No mirando', 'Copiando', 'Con silencio'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿A quién avisas si ofrecen coimas en tu barrio?', options: ['A un amigo cómplice', 'Al perro', 'A un adulto de confianza o autoridad', 'A nadie'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: 'Educar en valores desde niños…', options: ['Ver tele', 'No sirve', 'Forma adultos íntegros', 'Es aburrido'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Qué hace fuerte a una comunidad?', options: ['Con muros', 'La honestidad de todos', 'El silencio', 'El dinero'], correct: 1 },
  { topic: 'Prevención', icon: '🛡️', question: 'Vigilar y participar es…', options: ['Ciudadanía activa', 'Pérdida de tiempo', 'Meterse en líos', 'Dormir'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Cuál es tu papel contra la corrupción?', options: ['Aplaudir', 'Esperar a crecer', 'No hacer trampa y denunciar', 'Ninguno'], correct: 2 },
  { topic: 'Honestidad', icon: '💎', question: 'Devolver el vuelto de más es…', options: ['Tonto', 'Innecesario', 'Honestidad', 'Guardar silencio'], correct: 2 },
  { topic: 'Honestidad', icon: '💎', question: '¿La integridad se muestra cuando…?', options: ['Cuando hay recompensa', 'Cuando hay cámaras', 'En fotos', 'Cuando nadie mira'], correct: 3 },
  { topic: 'Honestidad', icon: '💎', question: 'Un error admitido a tiempo…', options: ['Empeora todo', 'Esconderlo', 'No importa', 'Se puede corregir y enseña'], correct: 3 },
  { topic: 'Honestidad', icon: '💎', question: '¿Qué admiras en una persona íntegra?', options: ['Su coherencia', 'Su ropa', 'Su bicicleta', 'Su dinero'], correct: 0 },
  { topic: 'Honestidad', icon: '💎', question: 'Ser coherente es…', options: ['Decir y hacer lo mismo', 'Cambiar según convenga', 'Cambiar de equipo', 'Callar siempre'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'El dinero robado deja sin…', options: ['Fiestas', 'Nada', 'Escuelas y hospitales', 'Recreos'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Qué deja la corrupción a los jóvenes?', options: ['Riqueza', 'Oportunidades', 'Menos futuro', 'Juguetes'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Un país corrupto…', options: ['Vuela', 'Avanza más', 'Crece menos y con desconfianza', 'Progresa igual'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Por qué castigar la corrupción?', options: ['Para que no se repita y reparar el daño', 'Para reír', 'Por costumbre', 'Por odio'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'La culpa de participar en trampas…', options: ['Un globo', 'No existe', 'Pasa rápido', 'Persigue mucho tiempo'], correct: 3 },
  { topic: 'Prevención', icon: '🛡️', question: 'Pedir comprobantes siempre…', options: ['Deja huella contra trampas', 'Es grosero', 'Para empapelar', 'Es lento'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Qué le pides a un candidato?', options: ['Su foto', 'Propuestas claras y cuentas claras', 'Favores', 'Regalos'], correct: 1 },
  { topic: 'Prevención', icon: '🛡️', question: 'Observar y anotar irregularidades sirve para…', options: ['Nada', 'Chismear', 'Para dormir', 'Denunciar con pruebas'], correct: 3 },
  { topic: 'Prevención', icon: '🛡️', question: 'La mejor vacuna contra la corrupción es…', options: ['La educación en valores', 'Jabón', 'El miedo', 'El castigo solo'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Cuándo empezar a ser íntegro?', options: ['Desde hoy mismo', 'Mañana siempre', 'De mayor', 'Nunca'], correct: 3 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué es el bien común?', options: ['Lo de nadie', 'Lo mío', 'Lo que beneficia a todos', 'Mi mochila'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Cuidar lo público es tarea de…', options: ['El vecino', 'Todos los ciudadanos', 'Solo autoridades', 'Nadie'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'Un parque limpio gracias a vecinos muestra…', options: ['La lluvia', 'Suerte', 'Ciudadanía activa', 'Dinero'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué rompe el bien común?', options: ['Cuidarlo', 'Ignorarlo', 'Usarlo para beneficio propio', 'Regarlo'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Pensar en los demás al decidir es…', options: ['Justicia', 'Tontería', 'Debilidad', 'Doler la cabeza'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Ser un ciudadano activo es…', options: ['Votar y olvidar', 'Dormir siesta', 'Dejar todo a otros', 'Vigilar, participar y exigir cuentas'], correct: 3 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Un comité detecta sobreprecio en una obra. ¿Qué hace?', options: ['Festejar', 'Pide su parte', 'Exige el expediente y denuncia', 'No se mete'], correct: 2 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Votar con información es…', options: ['Un deber ciudadano', 'Inútil', 'Un juego', 'Aburrido'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Para qué sirve participar en tu barrio?', options: ['Para pelear', 'Para mejorar juntos', 'Jugar solo', 'Para nada'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Ignorar los problemas del barrio…', options: ['Descansar', 'Los deja crecer', 'Ayuda', 'Es cómodo'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Un buen vecino…', options: ['Solo mira lo suyo', 'Se muda', 'Quejarse', 'Cuida lo común y avisa'], correct: 3 },
  { topic: 'Ética', icon: '🧭', question: 'La integridad significa…', options: ['Hacer lo correcto aunque nadie mire', 'Seguir a la mayoría', 'Hacer lo que conviene', 'Ser famoso'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: '¿Ética y ley se parecen en…?', options: ['Buscar lo justo', 'Nada', 'Letras', 'Enemigos'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: 'Actuar bien cuando nadie mira se llama…', options: ['Ética', 'Miedo', 'Suerte', 'Un truco'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: '¿Qué guía tus decisiones diarias?', options: ['Los dados', 'La tele', 'La moda', 'Tus valores'], correct: 3 },
  { topic: 'Ética', icon: '🧭', question: 'Copiar fama ajena como propia es…', options: ['Falta de ética', 'Un cumplido', 'Necesario', 'Homenaje'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: '¿Qué valor te hace devolver lo ajeno?', options: ['La honestidad', 'El olvido', 'El miedo', 'La viveza'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: 'El respeto significa…', options: ['Tratar bien a todos', 'Reírse', 'Obedecer siempre', 'Burlarse'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: '¿Qué valor falta al hacer trampa?', options: ['Honestidad', 'Energía', 'Fuerza', 'Alegría'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: 'Ser solidario es…', options: ['Ayudar sin esperar ventaja', 'Dar lo que sobra sin amor', 'Prestar con intereses', 'Guardar todo'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: '¿Qué une a una familia honesta?', options: ['El dinero', 'La confianza', 'El silencio', 'La tele'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'Un líder justo…', options: ['Escucha y decide parejo', 'Se esconde', 'Favorece amigos', 'Gritar'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué hace grande a una escuela?', options: ['Su dinero', 'Sus valores y su gente', 'Su edificio', 'El patio'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'El ejemplo de los mayores…', options: ['No importa', 'Enseña más que mil palabras', 'Sus canas', 'Aburre'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué dejas a otros con honestidad?', options: ['Nada', 'Buen ejemplo', 'Cuentas', 'Deudas'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Cuidar el parque del barrio es…', options: ['Mirarlo', 'Tarea de otros', 'Pérdida de tiempo', 'Ciudadanía'], correct: 3 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Por qué importan las elecciones limpias?', options: ['No importan', 'Son fiesta', 'Un desfile', 'Deciden el futuro de todos'], correct: 3 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Comprar votos es…', options: ['Ayuda', 'Democracia', 'Un regalo', 'Corrupción electoral'], correct: 3 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Informarte antes de opinar es…', options: ['Perder tiempo', 'Innecesario', 'Responsabilidad', 'Aburrido'], correct: 2 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Qué hace un observador electoral?', options: ['Vigila que todo sea limpio', 'Vota dos veces', 'Duerme', 'Vender dulces'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: '¿Miente quien calla una verdad importante?', options: ['Solo escribe', 'Ser tímido', 'No', 'A veces sí, por omisión'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: 'Prometer y no cumplir es…', options: ['Falta de palabra', 'Inteligente', 'Normal', 'Ser optimista'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: '¿Qué vale más que el dinero?', options: ['La fama', 'La integridad', 'Nada', 'Un videojuego'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: 'Elegir lo correcto aunque pierdas es…', options: ['Carácter', 'Tontería', 'Debilidad', 'Tener suerte'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: '¿Quién te evalúa cuando nadie mira?', options: ['Tus amigos', 'Tu conciencia', 'Nadie', 'La luna'], correct: 1 },
  { topic: 'Valores', icon: '🌱', question: 'Compartir lo que sabes…', options: ['Te empobrece', 'Quedarse sin nada', 'Multiplica el bien', 'Es tonto'], correct: 2 },
  { topic: 'Valores', icon: '🌱', question: 'Agradecer un favor…', options: ['Debilita', 'Humilla', 'Fortalece vínculos', 'Quedar mal'], correct: 2 },
  { topic: 'Valores', icon: '🌱', question: 'Pedir perdón sincero demuestra…', options: ['Miedo', 'Debilidad', 'Valentía', 'Llorar'], correct: 2 },
  { topic: 'Valores', icon: '🌱', question: '¿Qué construye la confianza?', options: ['Regalos caros', 'Promesas vacías', 'Actos justos repetidos', 'Hablar bajito'], correct: 2 },
  { topic: 'Valores', icon: '🌱', question: 'Perdonar sin olvidar la lección es…', options: ['Tonto', 'Sabio', 'Injusto', 'Guardar rencor'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'Ver corrupción y actuar es…', options: ['Imposible', 'Deber ciudadano', 'Correr', 'Peligroso siempre'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué frena más la corrupción?', options: ['Más dinero', 'Más estadios', 'Gente honesta más leyes justas', 'Más leyes solas'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Un país honesto…', options: ['Más pequeño', 'Es aburrido', 'Avanza unido', 'Es pobre'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Tu granito de arena importa porque…', options: ['Molesta', 'Suma con el de todos', 'No hacer nada', 'No importa'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿El final de este juego qué enseña?', options: ['A saltar', 'A esquivar', 'Que la integridad siempre gana', 'A volar'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué aprendiste hoy?', options: ['A cocinar', 'Trampas', 'Nada', 'A reconocer y frenar corrupción'], correct: 3 },
  { topic: 'Mixto', icon: '🌱', question: '¿A quién contarás lo aprendido?', options: ['A tu familia y amigos', 'En secreto', 'A nadie', 'Al espejo'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: 'Practicar honestidad cada día…', options: ['Cansa', 'Los fines de semana', 'Te hace íntegro', 'Aburre'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: '¿Volverías a jugar para repasar?', options: ['Sí, aprender es divertido', 'Solo si gano', 'Tal vez', 'No'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: 'La mejor victoria del juego es…', options: ['El récord', 'Más vidas', 'El puntaje', 'Ser íntegro de verdad'], correct: 3 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Qué es rendir cuentas?', options: ['Explicar en qué se usó lo confiado', 'Cantar', 'Callar', 'Esconderse'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Quién vigila al gobierno?', options: ['Solo él', 'El pueblo y sus instituciones', 'Los perros', 'Nadie'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'La prensa libre ayuda porque…', options: ['Entretiene', 'Contar chistes', 'Vende', 'Investiga y revela'], correct: 3 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Qué es un derecho ciudadano?', options: ['Un premio', 'Un dulce', 'Un regalo', 'Algo que nadie te puede quitar sin razón'], correct: 3 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Cuidar lo de todos…', options: ['No sirve', 'Romperlo', 'Es de todos', 'Es de tontos'], correct: 2 },
];
          ...
          <div className="max-w-5xl mx-auto animate-slide-up">
            ...
            <div className="space-y-4">
              ...
              <div
                ...
                style={{ background: 'linear-gradient(135deg, #1877F2 0%, #0d5bbf 100%)', boxShadow: '0 10px 30px rgba(24,119,242,0.35)' }}
              >
                <p className="font-black text-xl mb-1">👍 SÍGUENOS EN FACEBOOK 👍</p>
                <p className="text-white/90 mb-4">Entra y conoce más de nuestro trabajo</p>
                <div className="flex flex-col gap-2.5">
                  <a
                    href="https://www.facebook.com/profile.php?id=61594629992198"
                    target="_blank"
                    rel="noopener noreferrer"
