...
const FLAPPY_QUESTIONS: ExamQuestion[] = [
  { topic: 'Coima', icon: '💰', question: '¿Qué es una coima?', options: ['Un regalo entre amigos', 'Dinero o favores para lograr algo indebido', 'Una multa de tránsito', 'Un juego'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '¿Cuál es un ejemplo de coima?', options: ['Devolver una billetera', 'Pagar el precio justo', 'Un policía pide dinero para no multar', 'Ayudar a un amigo'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: '¿Quiénes participan en una coima?', options: ['Quien ofrece y quien acepta', 'Nadie en realidad', 'Solo un fantasma', 'Un saludo'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: 'Un inspector dice “págame y cierro los ojos”. ¿Qué es?', options: ['Un trámite normal', 'Una coima', 'Una propina', 'Solo los testigos'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '¿Una coima puede ser un favor y no dinero?', options: ['No, solo es dinero', 'Solo los lunes', 'Sí, también favores o regalos', 'Solo en sueños'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: 'Si te ofrecen una coima, ¿qué debes hacer?', options: ['Rechazarla y contarle a un adulto', 'Aceptarla rápido', 'Pedir más dinero', 'Esconderlo'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: '¿Por qué la gente ofrece coimas?', options: ['Por generosidad', 'Para saltarse reglas y ganar rápido', 'Por amor al arte', 'Para ayudar a todos'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '“Todos pagan para pasar”. ¿Qué respondes?', options: ['Pago también', 'Me voy sin decir nada', 'No pago y respeto la fila', 'Seguir pagando'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: '¿Qué siente quien pierde su turno por una coima?', options: ['Tristeza e injusticia', 'Alegría', 'Nada en especial', 'Ganas de pagar'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: '¿Aceptar una coima también es corrupción?', options: ['Solo el que ofrece', 'Sí, quien acepta también rompe reglas', 'Solo a veces', 'Solo mirar'], correct: 1 },
  { topic: 'Soborno', icon: '🤝', question: 'Un vendedor regala algo caro al inspector para que no revise. Es…', options: ['Amabilidad', 'Un descuento', 'Un soborno', 'Cortesía'], correct: 2 },
  { topic: 'Soborno', icon: '🤝', question: '¿Qué busca quien soborna?', options: ['Una ventaja indebida', 'Ayudar a todos', 'Hacer amigos', 'Paz mundial'], correct: 0 },
  { topic: 'Soborno', icon: '🤝', question: '¿El soborno afecta a otras personas?', options: ['No, solo a quien paga', 'Sí, quita oportunidades a otros', 'Solo al inspector', 'A los árboles'], correct: 1 },
  { topic: 'Soborno', icon: '🤝', question: 'Te ofrecen un premio por callar una trampa. ¿Qué haces?', options: ['Lo acepto', 'Pido dos premios', 'Lo rechazo y lo cuento', 'Pedir tres premios'], correct: 2 },
  { topic: 'Soborno', icon: '🤝', question: '¿Cuál es la diferencia entre propina y soborno?', options: ['La propina agradece; el soborno compra favores', 'No hay diferencia', 'La propina es más cara', 'Son iguales'], correct: 0 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Cuál es una señal de alerta?', options: ['Te dan comprobante', 'Te piden decidir rápido y en secreto', 'Te explican con calma', 'Un abrazo'], correct: 1 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Te piden dinero “sin recibo”. ¿Qué sospechas?', options: ['Es un descuento', 'Es un sorteo', 'Es una coima', 'Un premio'], correct: 2 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Qué frase es típica de una coima?', options: ['“Arreglemos entre nosotros”', '“Todo queda registrado”', '“Pasa mañana con cita”', '“Buenos días”'], correct: 0 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Un trámite sin fila a cambio de dinero es…', options: ['Eficiencia', 'Corrupción', 'Suerte', 'Magia'], correct: 1 },
  ...
  { topic: 'El daño', icon: '💔', question: '¿A quién dañan las coimas?', options: ['A toda la sociedad', 'Solo a quien paga', 'A nadie', 'A los marcianos'], correct: 0 },
  { topic: 'El daño', icon: '💔', question: 'El dinero de coimas en obras podría usarse en…', options: ['Fiestas privadas', 'Escuelas y hospitales', 'Nada importante', 'En cohetes de juguete'], correct: 1 },
  { topic: 'El daño', icon: '💔', question: '¿Qué pierde un niño cuando otro compra su lugar?', options: ['Nada', 'Un juguete', 'Su oportunidad ganada con esfuerzo', 'Un caramelo'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: 'Las coimas en hospitales provocan…', options: ['Menos medicinas para todos', 'Mejor atención', 'Más médicos', 'Más doctores'], correct: 0 },
  { topic: 'El daño', icon: '💔', question: '¿Por qué una coima pequeña también daña?', options: ['No daña', 'Porque rompe reglas y quita recursos', 'Porque es barata', 'Porque es pequeña'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '¿Qué es “mordida” en otros países?', options: ['Un dulce', 'Un impuesto', 'Otro nombre para la coima', 'Una fruta'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: 'Un chofer paga para evitar una multa justa. ¿Qué es?', options: ['Coima', 'Viveza', 'Ahorro', 'Un peaje'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: '¿La coima existe solo en el gobierno?', options: ['Sí, solo ahí', 'No, en escuelas y barrios también', 'Solo en otros países', 'Solo en la luna'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: 'Pagar para entrar a un equipo sin prueba es…', options: ['Mérito', 'Suerte', 'Trampa corrupta', 'Entrenamiento'], correct: 2 },
  ...
  { topic: 'Soborno', icon: '🤝', question: '¿Sobornar para ganar un concurso es justo?', options: ['Sí, si ganas', 'No, roba el premio al mejor', 'Solo si nadie ve', 'Un atajo válido'], correct: 1 },
  { topic: 'Soborno', icon: '🤝', question: 'Un juez recibe regalos de una parte. ¿Qué pasa?', options: ['Nada malo', 'Mejor juicio', 'Justicia vendida e injusta', 'Amistad verdadera'], correct: 2 },
  ...
  { topic: 'Soborno', icon: '🤝', question: 'Si ves un soborno, ¿qué haces?', options: ['Te unes', 'Lo cuentas a un adulto de confianza', 'Lo grabas y lo vendes', 'Unirte a ellos'], correct: 1 },
  { topic: 'Soborno', icon: '🤝', question: '¿El que recibe el soborno es inocente?', options: ['Sí, totalmente', 'Solo si es mucho', 'No, también es responsable', 'Siempre'], correct: 2 },
  { topic: 'Reconocerla', icon: '🔍', question: '“Sin testigos, mejor”. ¿Qué indica?', options: ['Que algo indebido se esconde', 'Profesionalismo', 'Rapidez', 'Eficiencia'], correct: 0 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Dónde NO hay corrupción?', options: ['Donde se paga en secreto', 'Donde todo es claro y con reglas', 'Donde nadie pregunta', 'Donde nadie mira'], correct: 1 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Un precio distinto según la cara del cliente es…', options: ['Marketing', 'Suerte', 'Abuso e injusticia', 'Oferta especial'], correct: 2 },
  { topic: 'Reconocerla', icon: '🔍', question: '¿Qué te protege de las coimas?', options: ['Conocer tus derechos y hablar', 'Llevar mucho dinero', 'No salir de casa', 'Tener suerte'], correct: 0 },
  { topic: 'Reconocerla', icon: '🔍', question: 'Piden “colaboración” para darte tu certificado. ¿Qué es?', options: ['Una donación', 'Una coima disfrazada', 'Un impuesto', 'Un saludo'], correct: 1 },
  { topic: 'El daño', icon: '💔', question: 'Sin coimas, las filas serían…', options: ['Más lentas', 'Iguales', 'Más justas para todos', 'Más aburridas'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: '¿Qué se rompe con cada coima?', options: ['La confianza entre personas', 'Nada', 'El dinero', 'Un vidrio'], correct: 0 },
  { topic: 'El daño', icon: '💔', question: 'Un hospital sin medicinas por desvíos muestra…', options: ['Mala suerte', 'El daño real de la corrupción', 'Falta de médicos', 'Un milagro'], correct: 1 },
  { topic: 'El daño', icon: '💔', question: '¿Quiénes sufren más la corrupción?', options: ['Los más ricos', 'Nadie', 'Los más vulnerables', 'Los aviones'], correct: 2 },
  { topic: 'El daño', icon: '💔', question: 'Cada coima aceptada enseña que…', options: ['La trampa funciona', 'Ser honesto paga', 'Nada', 'A volar'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: '¿Rechazar una coima es…?', options: ['Mala educación', 'Valiente honestidad', 'Un problema', 'De mala suerte'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: 'Decir “no, gracias” ante dinero indebido demuestra…', options: ['Miedo', 'Debilidad', 'Integridad', 'Que eres rico'], correct: 2 },
  { topic: 'Coima', icon: '💰', question: '¿Qué gana quien rechaza coimas?', options: ['Tranquilidad y respeto', 'Nada', 'Enemigos', 'Un trofeo'], correct: 0 },
  { topic: 'Coima', icon: '💰', question: 'Contar sobre una coima a un adulto es…', options: ['Chismear', 'Denunciar con valentía', 'Meterse en líos', 'Ser entrometido'], correct: 1 },
  { topic: 'Coima', icon: '💰', question: '¿La honestidad frente a coimas te protege?', options: ['No sirve', 'Solo un rato', 'Sí, toda la vida', 'Solo a famosos'], correct: 2 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Un funcionario le da un trabajo público a su familiar sin concurso. ¿Qué ocurrió?', options: ['Nepotismo, una forma de corrupción', 'Nada malo', 'Un sorteo', 'Un abrazo'], correct: 0 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿Qué es el nepotismo?', options: ['Un deporte', 'Dar puestos a familiares sin concurso', 'Un sorteo', 'Un postre'], correct: 1 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿Por qué el nepotismo es injusto?', options: ['No lo es', 'Es tradición', 'Quita oportunidades a los más capaces', 'Porque sí'], correct: 2 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Si tu familiar es el mejor y gana el concurso, ¿es nepotismo?', options: ['No, ganó con mérito', 'Sí, siempre', 'Depende del día', 'Un problema'], correct: 0 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿Quién debe pagar impuestos?', options: ['Solo los ricos', 'Todos los que la ley indica', 'Nadie', 'Los extraterrestres'], correct: 1 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿Para qué sirven los impuestos?', options: ['Para fiestas privadas', 'Para nada', 'Para escuelas, hospitales y caminos', 'Para comprar juguetes'], correct: 2 },
  ...
  { topic: 'Impuestos', icon: '🏛️', question: '¿Qué pasa si nadie paga impuestos?', options: ['Todo mejora', 'No habría escuelas ni hospitales', 'Nada', 'Todo gratis'], correct: 1 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Pedir comprobante al pagar ayuda a…', options: ['Nada', 'Perder tiempo', 'Que los impuestos lleguen a su destino', 'A decorar'], correct: 2 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Los impuestos son…', options: ['El aporte de todos para todos', 'Un castigo', 'Un regalo', 'Un juego'], correct: 0 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Qué es la transparencia?', options: ['Esconder información', 'Mostrar cómo se gasta el dinero público', 'Hablar mucho', 'Un color'], correct: 1 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Por qué importa la transparencia?', options: ['No importa', 'Es aburrida', 'Evita trampas a escondidas', 'Para aburrir'], correct: 2 },
  { topic: 'Transparencia', icon: '🔍', question: 'Un alcalde publica todos los gastos en internet. Eso es…', options: ['Transparencia', 'Pérdida de tiempo', 'Presumir', 'Un chisme'], correct: 0 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Qué frase pide transparencia?', options: ['“Confía y no preguntes”', '“Muéstrame las cuentas, por favor”', '“Mejor no saber”', '“Tú págame”'], correct: 1 },
  { topic: 'Transparencia', icon: '🔍', question: 'Sin transparencia, es más fácil…', options: ['Ser justo', 'Ahorrar', 'Esconder corrupción', 'Ser felices'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: '¿Qué es rendir cuentas?', options: ['Explicar en qué se usó lo confiado', 'Contar chistes', 'Esconderse', 'Dormir siesta'], correct: 0 },
  { topic: 'Rendición', icon: '🧾', question: '¿Quién debe rendir cuentas?', options: ['Nadie', 'Quien administra algo de otros', 'Solo los niños', 'Los gatos'], correct: 1 },
  { topic: 'Rendición', icon: '🧾', question: 'Un tesorero muestra todos los recibos del grupo. ¿Qué hace?', options: ['Pierde tiempo', 'Presume', 'Rinde cuentas', 'Hace magia'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: 'Rendir cuentas genera…', options: ['Confianza', 'Desconfianza', 'Pleitos', 'Enemigos'], correct: 0 },
  { topic: 'Rendición', icon: '🧾', question: 'Si administras dinero del salón, debes…', options: ['Gastarlo en secreto', 'Anotar y mostrar cada gasto', 'Regalarlo', 'Comprar dulces'], correct: 1 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿El nepotismo daña a otros?', options: ['No', 'Solo un poco', 'Sí, roba oportunidades', 'A las plantas'], correct: 2 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Elegir a un amigo para un cargo sin evaluar a nadie es…', options: ['Nepotismo', 'Amistad', 'Suerte', 'Ser popular'], correct: 0 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: '¿Cómo se evita el nepotismo?', options: ['Con más amigos', 'Con concursos justos y abiertos', 'Con secretos', 'Cerrar los ojos'], correct: 1 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'Un concurso abierto con jurado es…', options: ['Lento e inútil', 'Injusto', 'Justo y transparente', 'Una fiesta'], correct: 2 },
  { topic: 'Nepotismo', icon: '👨‍👩‍👧', question: 'El mérito significa…', options: ['Que te elijan por capacidad y esfuerzo', 'Tener contactos', 'Tener suerte', 'Ser famoso'], correct: 0 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿De quién es el dinero de los impuestos?', options: ['Del alcalde', 'De todos los ciudadanos', 'De nadie', 'Del banco'], correct: 1 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Evadir impuestos es…', options: ['Inteligente', 'Normal', 'Quitarle recursos a todos', 'Un juego'], correct: 2 },
  { topic: 'Impuestos', icon: '🏛️', question: '¿Qué financian los impuestos?', options: ['Escuelas, salud y caminos', 'Viajes de funcionarios', 'Fiestas', 'Dulces para todos'], correct: 0 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Pagar impuestos es…', options: ['Un castigo', 'Un deber ciudadano', 'Opcional', 'Divertido'], correct: 1 },
  { topic: 'Impuestos', icon: '🏛️', question: 'Si una obra cuesta el triple por sobreprecios, eso es…', options: ['Inflación', 'Calidad', 'Corrupción', 'Un milagro'], correct: 2 },
  { topic: 'Transparencia', icon: '🔍', question: 'El acceso a la información pública es…', options: ['Un derecho', 'Un privilegio', 'Un favor', 'Un secreto'], correct: 0 },
  { topic: 'Transparencia', icon: '🔍', question: '¿Qué herramienta frena la corrupción?', options: ['El secreto', 'La transparencia y la denuncia', 'La paciencia sola', 'Una varita mágica'], correct: 1 },
  { topic: 'Transparencia', icon: '🔍', question: 'Ocultar gastos públicos genera…', options: ['Confianza', 'Ahorro', 'Desconfianza', 'Alegría'], correct: 2 },
  { topic: 'Transparencia', icon: '🔍', question: 'Publicar las decisiones ayuda a…', options: ['Vigilar que todo sea justo', 'Confundir', 'Aburrir', 'A confundir más'], correct: 0 },
  { topic: 'Transparencia', icon: '🔍', question: 'La luz es enemiga de…', options: ['Las plantas', 'La corrupción', 'El día', 'De la noche'], correct: 1 },
  { topic: 'Rendición', icon: '🧾', question: '¿Qué muestra quien rinde cuentas?', options: ['Honestidad', 'Miedo', 'Culpa', 'Nada'], correct: 0 },
  { topic: 'Rendición', icon: '🧾', question: 'No rendir cuentas permite…', options: ['El orden', 'La confianza', 'Esconder desvíos', 'Ahorra tiempo'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: 'Tu grupo te eligió tesorero. ¿Qué haces?', options: ['Guardo el dinero en secreto', 'Muestro cada gasto al grupo', 'Lo presto a amigos', 'Esconder la alcancía'], correct: 1 },
  { topic: 'Rendición', icon: '🧾', question: '¿Cada cuánto se debe rendir cuentas?', options: ['Nunca', 'Una vez y ya', 'Siempre que se maneje algo ajeno', 'Cuando hay fiesta'], correct: 2 },
  { topic: 'Rendición', icon: '🧾', question: 'Rendir cuentas protege…', options: ['Los recursos de todos', 'Al tesorero corrupto', 'A nadie', 'Al olvido'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: 'Un dirigente se queda con dinero de la escuela. ¿Qué es?', options: ['Ahorro', 'Corrupción', 'Préstamo', 'Un error'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué debe hacer quien administra dinero del grupo?', options: ['Gastarlo', 'Esconderlo', 'Rendir cuentas y usarlo para el fin acordado', 'Repartirlo entre amigos'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Las leyes son iguales para…', options: ['Todas las personas por igual', 'Los ricos', 'Los políticos', 'Los semáforos'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué promueve rechazar coimas?', options: ['La viveza', 'La integridad', 'El miedo', 'La flojera'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'Un pueblo que vigila a sus autoridades…', options: ['Pierde tiempo', 'Se mete en líos', 'Frena la corrupción', 'Cansancio'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Denunciar por canales seguros es…', options: ['Valentía ciudadana', 'Peligroso siempre', 'Chisme', 'Quedarse dormido'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué necesita un país contra la corrupción?', options: ['Más secretos', 'Ciudadanos honestos e instituciones fuertes', 'Más dinero', 'Más feriados'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'El silencio ante la corrupción…', options: ['Ayuda', 'No afecta', 'La deja crecer', 'Música'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Hablar y denunciar es…', options: ['El primer paso para detenerla', 'Inútil', 'Peligroso', 'Un susurro'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: '¿Cuál es el mensaje de este juego?', options: ['Paga para ganar', 'La integridad siempre gana', 'Gana como sea', 'Volar alto'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: '¿Es honesto decir la verdad aunque cueste?', options: ['Nunca', 'Depende', 'Sí, la honestidad es un valor', 'Ser callado'], correct: 2 },
  { topic: 'Honestidad', icon: '💎', question: 'Encuentras dinero perdido. ¿Qué muestra integridad?', options: ['Devolverlo con todo su contenido', 'Gastarlo', 'Quedarte la mitad', 'Comprar dulces'], correct: 0 },
  { topic: 'Honestidad', icon: '💎', question: '¿Qué es hacer trampa en un examen?', options: ['Estudiar mucho', 'Copiar o hacer trampa', 'Preguntar al profesor', 'Un recreo'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: 'Copiar la tarea y firmarla es…', options: ['Ayuda', 'Trabajo en equipo', 'Plagio deshonesto', 'Un dibujo'], correct: 2 },
  { topic: 'Honestidad', icon: '💎', question: 'La honestidad se demuestra cuando…', options: ['Cuando nadie mira', 'Cuando todos miran', 'Cuando hay premio', 'Cuando hay dulces'], correct: 0 },
  { topic: 'Honestidad', icon: '💎', question: '¿Por qué cuesta ser honesto a veces?', options: ['Porque no conviene', 'Porque exige valentía', 'Porque es aburrido', 'Porque llueve'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: 'Un amigo te pide copiar. ¿Qué propones?', options: ['Copiar', 'Nada', 'Estudiar juntos', 'Copiar también'], correct: 2 },
  { topic: 'Honestidad', icon: '💎', question: 'Decir la verdad aunque traiga problemas es…', options: ['De valientes', 'Tonto', 'Inútil', 'Ser gruñón'], correct: 0 },
  { topic: 'Honestidad', icon: '💎', question: '¿La honestidad se entrena?', options: ['No se puede', 'Sí, con actos pequeños diarios', 'Solo de mayor', 'Comiendo'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: '¿Qué gana una persona honesta?', options: ['Nada', 'Enemigos', 'Confianza y respeto', 'Un helado'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Qué le puede pasar a quien ofrece coimas?', options: ['Prisión, multas e inhabilitación', 'Nada', 'Un premio', 'Nada malo'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Además de lo legal, la corrupción destruye…', options: ['Los semáforos', 'La confianza entre ciudadanos', 'Los feriados', 'Las nubes'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿La corrupción tiene castigo?', options: ['No', 'Solo retos', 'Sí, la ley la sanciona', 'Solo multas de juguete'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Quien roba dinero público deberá…', options: ['Devolverlo y responder ante la ley', 'Quedárselo', 'Esconderlo mejor', 'Ser famoso'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Por qué existen castigos contra la corrupción?', options: ['Por venganza', 'Para proteger a todos y desanimar trampas', 'Por tradición', 'Para asustar'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Una mala fama por corrupto dura…', options: ['Un día', 'Nada', 'Mucho tiempo', 'Un recreo'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Qué pierde un corrupto descubierto?', options: ['Confianza y reputación', 'Nada', 'Dinero y premios', 'Sus llaves'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Las consecuencias llegan…', options: ['Nunca', 'Tarde o temprano', 'Solo a otros', 'En bicicleta'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿A quién castiga la ley anticorrupción?', options: ['A los honestos', 'A los testigos', 'A quien ofrece y a quien acepta', 'A los pájaros'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Evitar la corrupción te evita…', options: ['Problemas legales y culpa', 'Amigos', 'Dinero', 'La tarea'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Cómo se previene la corrupción?', options: ['Exigiendo transparencia y denunciando', 'Ignorando todo', 'Pagando más rápido', 'Con magia'], correct: 1 },
  { topic: 'Prevención', icon: '🛡️', question: 'Si ves algo incorrecto en tu municipio, puedes…', options: ['Callar', 'Participar', 'Denunciar por canales seguros', 'Pedir un deseo'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: 'Prevenir es mejor porque…', options: ['Evita el daño antes de que ocurra', 'Es más caro', 'Es aburrido', 'Porque sí'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Qué frena las coimas en un trámite?', options: ['Pagar más', 'Trámites claros y comprobantes', 'Ir de noche', 'Con prisa'], correct: 1 },
  { topic: 'Prevención', icon: '🛡️', question: 'En tu escuela, ¿cómo previenes trampas?', options: ['Copiando', 'No mirando', 'Reglas claras y honestidad', 'Con silencio'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: '¿A quién avisas si ofrecen coimas en tu barrio?', options: ['A un adulto de confianza o autoridad', 'A nadie', 'A un amigo cómplice', 'Al perro'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: 'Educar en valores desde niños…', options: ['No sirve', 'Forma adultos íntegros', 'Es aburrido', 'Ver tele'], correct: 1 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Qué hace fuerte a una comunidad?', options: ['El silencio', 'El dinero', 'La honestidad de todos', 'Con muros'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: 'Vigilar y participar es…', options: ['Ciudadanía activa', 'Meterse en líos', 'Pérdida de tiempo', 'Dormir'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Cuál es tu papel contra la corrupción?', options: ['Ninguno', 'No hacer trampa y denunciar', 'Esperar a crecer', 'Aplaudir'], correct: 1 },
  ...
  { topic: 'Honestidad', icon: '💎', question: '¿La integridad se muestra cuando…?', options: ['Cuando nadie mira', 'Cuando hay cámaras', 'Cuando hay recompensa', 'En fotos'], correct: 0 },
  { topic: 'Honestidad', icon: '💎', question: 'Un error admitido a tiempo…', options: ['Empeora todo', 'Se puede corregir y enseña', 'No importa', 'Esconderlo'], correct: 1 },
  { topic: 'Honestidad', icon: '💎', question: '¿Qué admiras en una persona íntegra?', options: ['Su dinero', 'Su ropa', 'Su coherencia', 'Su bicicleta'], correct: 2 },
  { topic: 'Honestidad', icon: '💎', question: 'Ser coherente es…', options: ['Decir y hacer lo mismo', 'Cambiar según convenga', 'Callar siempre', 'Cambiar de equipo'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'El dinero robado deja sin…', options: ['Nada', 'Fiestas', 'Escuelas y hospitales', 'Recreos'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Qué deja la corrupción a los jóvenes?', options: ['Oportunidades', 'Riqueza', 'Menos futuro', 'Juguetes'], correct: 2 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'Un país corrupto…', options: ['Crece menos y con desconfianza', 'Avanza más', 'Progresa igual', 'Vuela'], correct: 0 },
  { topic: 'Consecuencias', icon: '⚖️', question: '¿Por qué castigar la corrupción?', options: ['Por odio', 'Para que no se repita y reparar el daño', 'Por costumbre', 'Para reír'], correct: 1 },
  { topic: 'Consecuencias', icon: '⚖️', question: 'La culpa de participar en trampas…', options: ['No existe', 'Pasa rápido', 'Persigue mucho tiempo', 'Un globo'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: 'Pedir comprobantes siempre…', options: ['Deja huella contra trampas', 'Es grosero', 'Es lento', 'Para empapelar'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Qué le pides a un candidato?', options: ['Regalos', 'Propuestas claras y cuentas claras', 'Favores', 'Su foto'], correct: 1 },
  { topic: 'Prevención', icon: '🛡️', question: 'Observar y anotar irregularidades sirve para…', options: ['Nada', 'Chismear', 'Denunciar con pruebas', 'Para dormir'], correct: 2 },
  { topic: 'Prevención', icon: '🛡️', question: 'La mejor vacuna contra la corrupción es…', options: ['La educación en valores', 'El miedo', 'El castigo solo', 'Jabón'], correct: 0 },
  { topic: 'Prevención', icon: '🛡️', question: '¿Cuándo empezar a ser íntegro?', options: ['De mayor', 'Nunca', 'Desde hoy mismo', 'Mañana siempre'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué es el bien común?', options: ['Lo mío', 'Lo de nadie', 'Lo que beneficia a todos', 'Mi mochila'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Cuidar lo público es tarea de…', options: ['Todos los ciudadanos', 'Solo autoridades', 'Nadie', 'El vecino'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: 'Un parque limpio gracias a vecinos muestra…', options: ['Suerte', 'Ciudadanía activa', 'Dinero', 'La lluvia'], correct: 1 },
  ...
  { topic: 'Mixto', icon: '🌱', question: 'Pensar en los demás al decidir es…', options: ['Justicia', 'Debilidad', 'Tontería', 'Doler la cabeza'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Ser un ciudadano activo es…', options: ['Votar y olvidar', 'Vigilar, participar y exigir cuentas', 'Dejar todo a otros', 'Dormir siesta'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Un comité detecta sobreprecio en una obra. ¿Qué hace?', options: ['Pide su parte', 'No se mete', 'Exige el expediente y denuncia', 'Festejar'], correct: 2 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Votar con información es…', options: ['Un deber ciudadano', 'Inútil', 'Aburrido', 'Un juego'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Para qué sirve participar en tu barrio?', options: ['Para nada', 'Para mejorar juntos', 'Para pelear', 'Jugar solo'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Ignorar los problemas del barrio…', options: ['Ayuda', 'Es cómodo', 'Los deja crecer', 'Descansar'], correct: 2 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Un buen vecino…', options: ['Cuida lo común y avisa', 'Solo mira lo suyo', 'Se muda', 'Quejarse'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: 'La integridad significa…', options: ['Seguir a la mayoría', 'Hacer lo correcto aunque nadie mire', 'Hacer lo que conviene', 'Ser famoso'], correct: 1 },
  { topic: 'Ética', icon: '🧭', question: '¿Ética y ley se parecen en…?', options: ['Nada', 'Letras', 'Buscar lo justo', 'Enemigos'], correct: 2 },
  { topic: 'Ética', icon: '🧭', question: 'Actuar bien cuando nadie mira se llama…', options: ['Ética', 'Suerte', 'Miedo', 'Un truco'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: '¿Qué guía tus decisiones diarias?', options: ['La moda', 'Tus valores', 'La tele', 'Los dados'], correct: 1 },
  { topic: 'Ética', icon: '🧭', question: 'Copiar fama ajena como propia es…', options: ['Homenaje', 'Necesario', 'Falta de ética', 'Un cumplido'], correct: 2 },
  { topic: 'Valores', icon: '🌱', question: '¿Qué valor te hace devolver lo ajeno?', options: ['La honestidad', 'La viveza', 'El miedo', 'El olvido'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: 'El respeto significa…', options: ['Burlarse', 'Tratar bien a todos', 'Obedecer siempre', 'Reírse'], correct: 1 },
  { topic: 'Valores', icon: '🌱', question: '¿Qué valor falta al hacer trampa?', options: ['Alegría', 'Fuerza', 'Honestidad', 'Energía'], correct: 2 },
  ...
  { topic: 'Mixto', icon: '🌱', question: 'Un líder justo…', options: ['Favorece amigos', 'Se esconde', 'Escucha y decide parejo', 'Gritar'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué hace grande a una escuela?', options: ['Sus valores y su gente', 'Su edificio', 'Su dinero', 'El patio'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: 'El ejemplo de los mayores…', options: ['No importa', 'Enseña más que mil palabras', 'Aburre', 'Sus canas'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué dejas a otros con honestidad?', options: ['Nada', 'Deudas', 'Buen ejemplo', 'Cuentas'], correct: 2 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Cuidar el parque del barrio es…', options: ['Ciudadanía', 'Tarea de otros', 'Pérdida de tiempo', 'Mirarlo'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Por qué importan las elecciones limpias?', options: ['No importan', 'Deciden el futuro de todos', 'Son fiesta', 'Un desfile'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Comprar votos es…', options: ['Democracia', 'Ayuda', 'Corrupción electoral', 'Un regalo'], correct: 2 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Informarte antes de opinar es…', options: ['Responsabilidad', 'Aburrido', 'Innecesario', 'Perder tiempo'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Qué hace un observador electoral?', options: ['Vota dos veces', 'Vigila que todo sea limpio', 'Duerme', 'Vender dulces'], correct: 1 },
  { topic: 'Ética', icon: '🧭', question: '¿Miente quien calla una verdad importante?', options: ['No', 'A veces sí, por omisión', 'Solo escribe', 'Ser tímido'], correct: 2 },
  { topic: 'Ética', icon: '🧭', question: 'Prometer y no cumplir es…', options: ['Falta de palabra', 'Normal', 'Inteligente', 'Ser optimista'], correct: 0 },
  { topic: 'Ética', icon: '🧭', question: '¿Qué vale más que el dinero?', options: ['Nada', 'La fama', 'La integridad', 'Un videojuego'], correct: 1 },
  { topic: 'Ética', icon: '🧭', question: 'Elegir lo correcto aunque pierdas es…', options: ['Tontería', 'Debilidad', 'Carácter', 'Tener suerte'], correct: 2 },
  { topic: 'Ética', icon: '🧭', question: '¿Quién te evalúa cuando nadie mira?', options: ['Tu conciencia', 'Nadie', 'Tus amigos', 'La luna'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: 'Compartir lo que sabes…', options: ['Te empobrece', 'Multiplica el bien', 'Es tonto', 'Quedarse sin nada'], correct: 1 },
  { topic: 'Valores', icon: '🌱', question: 'Agradecer un favor…', options: ['Humilla', 'Debilita', 'Fortalece vínculos', 'Quedar mal'], correct: 2 },
  { topic: 'Valores', icon: '🌱', question: 'Pedir perdón sincero demuestra…', options: ['Valentía', 'Debilidad', 'Miedo', 'Llorar'], correct: 0 },
  { topic: 'Valores', icon: '🌱', question: '¿Qué construye la confianza?', options: ['Promesas vacías', 'Actos justos repetidos', 'Regalos caros', 'Hablar bajito'], correct: 1 },
  { topic: 'Valores', icon: '🌱', question: 'Perdonar sin olvidar la lección es…', options: ['Tonto', 'Injusto', 'Sabio', 'Guardar rencor'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Ver corrupción y actuar es…', options: ['Deber ciudadano', 'Peligroso siempre', 'Imposible', 'Correr'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué frena más la corrupción?', options: ['Más leyes solas', 'Gente honesta más leyes justas', 'Más dinero', 'Más estadios'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: 'Un país honesto…', options: ['Es pobre', 'Es aburrido', 'Avanza unido', 'Más pequeño'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'Tu granito de arena importa porque…', options: ['Suma con el de todos', 'No importa', 'Molesta', 'No hacer nada'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: '¿El final de este juego qué enseña?', options: ['A volar', 'Que la integridad siempre gana', 'A esquivar', 'A saltar'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Qué aprendiste hoy?', options: ['Nada', 'Trampas', 'A reconocer y frenar corrupción', 'A cocinar'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: '¿A quién contarás lo aprendido?', options: ['A tu familia y amigos', 'A nadie', 'Al espejo', 'En secreto'], correct: 0 },
  { topic: 'Mixto', icon: '🌱', question: 'Practicar honestidad cada día…', options: ['Cansa', 'Te hace íntegro', 'Aburre', 'Los fines de semana'], correct: 1 },
  { topic: 'Mixto', icon: '🌱', question: '¿Volverías a jugar para repasar?', options: ['No', 'Tal vez', 'Sí, aprender es divertido', 'Solo si gano'], correct: 2 },
  { topic: 'Mixto', icon: '🌱', question: 'La mejor victoria del juego es…', options: ['Ser íntegro de verdad', 'El puntaje', 'El récord', 'Más vidas'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Qué es rendir cuentas?', options: ['Esconderse', 'Explicar en qué se usó lo confiado', 'Callar', 'Cantar'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Quién vigila al gobierno?', options: ['Nadie', 'Solo él', 'El pueblo y sus instituciones', 'Los perros'], correct: 2 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'La prensa libre ayuda porque…', options: ['Investiga y revela', 'Entretiene', 'Vende', 'Contar chistes'], correct: 0 },
  { topic: 'Ciudadanía', icon: '🗳️', question: '¿Qué es un derecho ciudadano?', options: ['Un regalo', 'Algo que nadie te puede quitar sin razón', 'Un premio', 'Un dulce'], correct: 1 },
  { topic: 'Ciudadanía', icon: '🗳️', question: 'Cuidar lo de todos…', options: ['Es de tontos', 'No sirve', 'Es de todos', 'Romperlo'], correct: 2 },
];
